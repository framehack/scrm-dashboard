...
export default [
  { path: '/', redirect: '/staff-admin/login' },
  {
    path: '/staff-admin/login',
    component: '@/layouts/LoginLayout',
    routes: [
      {
        name: '员工登录',
        path: '/staff-admin/login',
        component: '@/pages/StaffAdmin/Login',
      },
    ],
  },
  {
    path: '/staff-admin/', component: '@/layouts/StaffAdminSecurityLayout',
    routes: [
      {
        path: '/staff-admin/',
        component: '@/layouts/BasicLayout',
        routes: [
          ...
          },
          {
            ...
            name: '首页',
            icon: 'Home',
            component: '@/pages/StaffAdmin/Welcome/index',
          },
          {
            path: '/staff-admin/customer-management',
            icon: 'User',
            ...
            routes: [
              {
                ...
                name: '客户管理',
                icon: 'IdcardOutlined',
                component: '@/pages/StaffAdmin/Customer/index',
                authority: [BizCustomerInfo_Full, BizCustomerInfo_Read],
              },
              {
                path: '/staff-admin/customer-management/customer/detail',
                component: '@/pages/StaffAdmin/Customer/detail',
                authority: [BizCustomerInfo_Full, BizCustomerInfo_Read],
              },
              {
                path: '/staff-admin/group-chat/list',
                name: '客户群列表',
                component: '@/pages/StaffAdmin/GroupChat/index',
                icon: 'icon-every-user',
                authority: [BizCustomerGroupChat_Full, BizCustomerGroupChat_Read],
              }
            ]
            ...
            routes: [
              {
                name: '员工管理',
                path: '/staff-admin/company-management/staff',
                component: '@/pages/StaffAdmin/Staff/index',
                icon: 'icon-staff',
                authority: [BizRole_Full, BizRole_Read],
              },
              {
                name: '权限管理',
                path: '/staff-admin/company-management/role',
                component: '@/pages/StaffAdmin/Role/index',
                icon: 'icon-permissions',
              },
              {
                path: '/staff-admin/company-management/role/create',
                component: '@/pages/StaffAdmin/Role/create',
              },
              {
                path: '/staff-admin/company-management/role/edit',
                component: '@/pages/StaffAdmin/Role/edit',
              },
            ]
          }
        ]
